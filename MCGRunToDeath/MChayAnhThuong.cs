...
namespace MCChayAnhThuong
{
    public class MChayAnhThuong
    {
        ...
        private int chisolop, chayhieuung, dochamkichhoat = 5, sodemluot;
        private float chieurong, chieudai, gocxoay, gtgocxoay, gsx, gsy;
        private SoundEffect amkichhoat;
        public MChayAnhThuong(int chiso, Texture2D hinhanhthuong, Texture2D hinhanhkichhoat, Vector2 toado, SoundEffect amthanhkichhoat, Rectangle kichthuocmanhinh, Vector2 tilemanhinh)
        {
            chisolop = chiso;
